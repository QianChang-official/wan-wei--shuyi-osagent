...
TECHNOLOGIES: list[ResearchTechnology] = [
    ...
    ResearchTechnology(
        ...
        evidence_files=["CHANGELOG.md", "backend/app/platform/service.py"],
    ...
    ResearchTechnology(
        ...
        evidence_files=["CHANGELOG.md", "backend/app/tuning/service.py"],
    ...
    ResearchTechnology(
        ...
        evidence_files=["backend/app/memory_arena/cases", "CHANGELOG.md"],
    ...
    ResearchTechnology(
        ...
        evidence_files=["CHANGELOG.md", "backend/app/research_adoption/service.py"],
    ...
    ResearchTechnology(
        ...
        evidence_files=["backend/app/tool_registry/service.py", "CHANGELOG.md"],
...
VERSION_MAP: list[VersionMapping] = [
    ...
    VersionMapping(
        ...
        evidence_files=["CHANGELOG.md", "reports/archive/production_memory_eval_report.md"],
    ),
    VersionMapping(
        version="v0.7",
