...
| 待补齐 | Kylin 原生 SDK Bridge 的目标机 smoke/性能实测、麒麟系统适配实测报告、偏好提取准确率、知识检索召回率、知识冲突处理正确率、PPT 与演示视频 |

提交前 P0 建议：

- 在银河麒麟桌面环境构建 `native/kylin-sdk-bridge`，并完成 embedding/vector SDK 的 smoke / compatibility test。
