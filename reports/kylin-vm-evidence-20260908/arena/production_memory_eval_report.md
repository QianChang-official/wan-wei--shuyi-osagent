...
| memory_reuse_success_rate | 0.3333 |
...
### tier_promotion_lifecycle — 记忆分层流转端到端：写入 → 召回 → 反思 → 晋升 short_term（#56）: ✅ PASS

- ✅ [s1_write_experience] lifecycle=active (actual=active)
- ✅ [s2_recall_same_goal] evidence_cards_present
- ✅ [s2_recall_same_goal] memories_recalled
- ✅ [s3_reflect_promotes_tier] tier_promotion_triggered (actual=tier_promote)
